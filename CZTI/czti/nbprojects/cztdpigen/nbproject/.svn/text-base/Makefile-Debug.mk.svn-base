...
OBJECTFILES= \
	...
	${OBJECTDIR}/_ext/1134772763/main.o
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../bin/cztdpigen

../../bin/cztdpigen: ../../lib/libcfitsio.a

../../bin/cztdpigen: ../../lib/libglog.a

../../bin/cztdpigen: ../../lib/libpil.a

../../bin/cztdpigen: ${OBJECTFILES}
	${MKDIR} -p ../../bin
	${LINK.cc} -o ../../bin/cztdpigen ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/_ext/232673814/badpixCALDB.o: ../../src/common/badpixCALDB.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/232673814
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../include -I../../src/common -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/232673814/badpixCALDB.o ../../src/common/badpixCALDB.cpp

${OBJECTDIR}/_ext/232673814/caldbHandler.o: ../../src/common/caldbHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/232673814
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../include -I../../src/common -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/232673814/caldbHandler.o ../../src/common/caldbHandler.cpp
...
${OBJECTDIR}/_ext/232673814/level2validation.o: ../../src/common/level2validation.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/232673814
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../include -I../../src/common -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/232673814/level2validation.o ../../src/common/level2validation.cpp
...
${OBJECTDIR}/_ext/232673814/validations.o: ../../src/common/validations.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/232673814
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../include -I../../src/common -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/232673814/validations.o ../../src/common/validations.cpp

${OBJECTDIR}/_ext/1134772763/cztdpigen_v2.o: ../../src/cztdpigen/cztdpigen_v2.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1134772763
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../include -I../../src/common -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1134772763/cztdpigen_v2.o ../../src/cztdpigen/cztdpigen_v2.cpp

${OBJECTDIR}/_ext/1134772763/main.o: ../../src/cztdpigen/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1134772763
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../include -I../../src/common -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1134772763/main.o ../../src/cztdpigen/main.cpp
