...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cztgaas

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cztgaas: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cztgaas ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/_ext/1055853538/main.o: ../../src/cztgaas/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1055853538
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1055853538/main.o ../../src/cztgaas/main.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cztgaas
