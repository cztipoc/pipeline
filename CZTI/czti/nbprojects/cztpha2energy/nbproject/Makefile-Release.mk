...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cztpha2energy

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cztpha2energy: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cztpha2energy ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/_ext/1092292547/main.o: ../../src/cztpha2energy/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1092292547
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1092292547/main.o ../../src/cztpha2energy/main.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cztpha2energy
