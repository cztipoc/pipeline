 ...
 * @file cztdpigen_v2.h
 * @author Tanul Gupta
 * @date Created on May 16, 2015, 9:28 AM
 * @brief cztpha2energyv2.h
 * @details This module bins the count data of the pixel based on given time
 *  and energy ranges and generates a detector plane image.
 */
